package com.bank.bian.paymentorder.model;
...
/**
 * The BIAN control record for this service domain: "Payment Order Procedure".
 *
 ...
 * to its asset type (Payment Order). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Payment Order Procedure";
